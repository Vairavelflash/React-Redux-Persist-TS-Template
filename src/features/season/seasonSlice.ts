...
import { GameSummary, RankingRow, SeasonState, TeamRecord } from '../../types/sim';
...
export const { resetSeason, simToWeek, advanceSeasonPhase } = seasonSlice.actions;
